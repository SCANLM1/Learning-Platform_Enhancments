var $codeFormattingActivity = {
    ...
    loadDependencies: function (callback) {
        ...
        const cssLinks = [
            ...
            "code-formatting-activity-idevice.css"
        ];
    ...
    renderFormatCodeActivities: function () {
        document.querySelectorAll(".code-formatting-activity-idevice").forEach(activity => {
