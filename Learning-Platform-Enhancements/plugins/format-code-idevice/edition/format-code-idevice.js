var $exeDevice = {
    ...
    init: function () {
        const html = `
            <div id="formatCodeForm">
                ...
                <p><label for="formatCodeTitle"><strong>Title of module:</strong></label><br>
                <input type="text" id="formatCodeTitle" style="width:100%;" /></p>
    ...
    save: function () {
        const title = $("#formatCodeTitle").val() || "";
        ...
        const html = `
            <div class="format-code-idevice">
                <div class="format-code-title">${$('<div>').text(title).html()}</div>
    ...
    getPreviousValues: function (field) {
        ...
        const title = wrapper.find(".format-code-title").text() || "";
